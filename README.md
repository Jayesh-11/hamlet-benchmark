...
- random-color-mode - don't use this if you are sensitive to flashing colors

### Screensaver mode

Add delay using `-d 1` then the program would keep typing Hamlet slowly - fun to watch 
